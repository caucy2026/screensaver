...
reports=[]
for label,package,kind in [('KEMI双屏屏保','com.kemi.dualscreensaver','ui'),('KEMI双屏屏保服务','com.kemi.dualscreensaver.service','service')]:
    ...
    with zipfile.ZipFile(apk) as z:
        ...
        assert ('assets/silver_video.mp4' in z.namelist())==(kind=='service')
        ...
        for id,stem in [(2,'douyin'),(3,'spring')]:
            ...
            assert (f'assets/preview_{stem}.jpg' in z.namelist())==(present and kind=='ui')
            assert (f'assets/{stem}_video.mp4' in z.namelist())==(present and kind=='service')
